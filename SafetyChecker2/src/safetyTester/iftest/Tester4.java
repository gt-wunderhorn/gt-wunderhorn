...
public class Tester4 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String mainFunction ="<safetyTestCode.iftest.Test4: void test()>";
		LogUtils.infoln("safetyTester.iftest.Tester4... Test started...");
		...
		LogUtils.infoln("safetyTester.iftest.Tester4... Test finished...");
		/// There will no need to forest anymore....
//		Forest forest1 = new Forest(stores,
//				"<de.ecspride.ImplicitFlow4: void tester()>", "<de.ecspride.ImplicitFlow4: void onCreate2(android.os.Bundle)>");
//				//"<de.ecspride.ImplicitFlow4: void onCreate(android.os.Bundle)>");
//		forest1.TestCorrect();
