...
public class MultidimensionalArray1 {
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		String[] sootArgs=new String[]{
			"-process-dir","C:/Users/qizhou/workspace/InfoFlow1/BechMark/MultidimensionalArray1/bin/classes",
			"-output-dir","src/output/MultidimensionalArray1"
		};
		...
		Forest forest1 = new Forest(stores,
				"<edu.mit.array_slice.FlowTestDroidSafeFailed: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
