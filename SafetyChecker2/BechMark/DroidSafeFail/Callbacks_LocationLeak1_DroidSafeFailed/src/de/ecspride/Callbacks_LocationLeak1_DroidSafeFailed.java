 ...
 */
public class Callbacks_LocationLeak1_DroidSafeFailed extends Activity {
    ...
    protected void onResume (){
    	super.onResume();
    	latitude = String.valueOf(Double.valueOf(latitude)-Double.valueOf(latitude));
    	longtitude = String.valueOf(Double.valueOf(longtitude)-Double.valueOf(longtitude));
