...
public class ArrayAccess1 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/ArrayAccess1/bin/classes",
				"-output-dir", "src/output/DroidBench/ArrayAccess1" };
		...
		Forest forest1 = new Forest(stores,
				"<de.ecspride.ArrayAccess1: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
