...
public class StaticInitialization3 {
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		String[] sootArgs=new String[]{
			"-process-dir","/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/StaticInitialization3/bin/classes",
			"-output-dir","src/output/DroidBench/StaticInitialization3"
		};
		...
		Forest forest1 = new Forest(stores,
				"<edu.mit.clinit.MainActivity: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
