...
public class ArrayAccess2 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/ArrayAccess2/bin/classes",
				"-output-dir", "src/output/DroidBench/ArrayAccess2" };
		...
		Forest forest1 = new Forest(stores,
				"<de.ecspride.ArrayAccess2: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
