...
public class ArrayCopy1 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/ArrayCopy1/bin/classes",
				"-output-dir", "src/output/DroidBench/ArrayCopy1" };
		...
		Forest forest1 = new Forest(stores,
				"<edu.mit.array_copy.MainActivity: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
