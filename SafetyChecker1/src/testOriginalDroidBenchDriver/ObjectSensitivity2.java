...
public class ObjectSensitivity2 {
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		String[] sootArgs=new String[]{
			"-process-dir","/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/ObjectSensitivity2/bin/classes",
			"-output-dir","src/output/DroidBench/ObjectSensitivity2"
		};
		...
		Forest forest1 = new Forest(stores,
				"<de.ecspride.OverwiteValue: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
