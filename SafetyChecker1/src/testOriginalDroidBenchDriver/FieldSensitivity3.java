...
public class FieldSensitivity3 {
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		String[] sootArgs=new String[]{
			"-process-dir","/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/FieldSensitivity3/bin/classes",
			"-output-dir","src/output/DroidBench/FieldSensitivity3"
		};
		...
		Forest forest1 = new Forest(stores,
				"<de.ecspride.FieldSensitivity3: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
