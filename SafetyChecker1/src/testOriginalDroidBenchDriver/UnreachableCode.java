...
public class UnreachableCode {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidBench/UnreachableCode/bin/classes",
				"-output-dir", "src/output/DroidBench/UnreachableCode" };
		...
		Forest forest1 = new Forest(stores,
				"<de.ecspride.UnreachableCode: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
