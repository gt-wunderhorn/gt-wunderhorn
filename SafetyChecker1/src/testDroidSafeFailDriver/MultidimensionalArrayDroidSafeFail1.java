...
public class MultidimensionalArrayDroidSafeFail1 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidSafeFail/ArraysAndLists_MultidimensionalArrayDroidSafeFail1/bin/classes",
				"-output-dir", "src/output/DroidSafeFail/ArraysAndLists_MultidimensionalArrayDroidSafeFail1" };
		...
		Forest forest1 = new Forest(stores,
				"<edu.mit.array_slice.MultiDimensionalArray1_DroidSafeFailed1: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
