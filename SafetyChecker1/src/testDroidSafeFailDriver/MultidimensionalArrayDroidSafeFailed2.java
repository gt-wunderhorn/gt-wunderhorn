...
public class MultidimensionalArrayDroidSafeFailed2 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidSafeFail/ArraysAndLists_MultidimensionalArrayDroidSafeFailed2/bin/classes",
				"-output-dir", "src/output/DroidSafeFail/ArraysAndLists_MultidimensionalArrayDroidSafeFailed2" };
		...
		Forest forest1 = new Forest(stores,
				"<edu.mit.array_slice.MultiDimensionalArray1_DroidSafeFailed2: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
