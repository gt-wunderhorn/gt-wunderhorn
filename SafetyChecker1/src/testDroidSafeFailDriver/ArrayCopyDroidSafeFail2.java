...
public class ArrayCopyDroidSafeFail2 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String[] sootArgs = new String[] {
				"-process-dir",
				"/Users/qizhou/Documents/workspace/InfoFlow1/BechMark/DroidSafeFail/ArrayCopyDroidSafeFaile1/bin/classes",
		...
		Forest forest1 = new Forest(stores,
				"<com.flow.arraycopy.ArrayCopy2: void onCreate(android.os.Bundle)>");
		forest1.TestCorrect();
