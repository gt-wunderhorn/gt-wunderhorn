...
public class Tester1 {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		String mainFunction ="<safetyTestCode.Test1: void test()>";
		System.out.println("safetyTester.Tester1... Test started...");
	
		try {	
			Forest forest1 = new Forest(stores, "<safetyTestCode.Test1: void test()>");
			forest1.TestCorrect();
		...
		System.out.println("safetyTester.Tester1... Test finished...");
